  ...
  try {
    ...
    if (existingRecords > 0) {
      try {
        ...
        await pool.query(`
          INSERT INTO "Pacientes" ("NomPaci", "FeNaci", "DireCasa", "NumCel", "Email", "Contraseña")
          SELECT 
            "NomPaci", 
            "FeNaci", 
            "DireCasa", 
        ...
        console.log("💡 Los datos del respaldo están en 'Pacientes_backup' y pueden restaurarse manualmente");
      }
    }
