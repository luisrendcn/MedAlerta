...
export const API_ENDPOINTS = {
  ...
  CUIDADOR_REGISTER: "/api/cuidadores/register",
  CUIDADOR_LOGIN: "/api/cuidadores/login",
  CUIDADOR_CUMPLIMIENTO: "/api/cuidadores/pacientes-cumplimiento",
  // Para logs por paciente usar rutas dinámicas construidas en el cliente
  CUIDADOR_LOGS_BASE: "/api/cuidadores/paciente",
  CUIDADOR_PACIENTES: "/api/cuidadores/pacientes",
  CUIDADOR_PACIENTE_DELETE: "/api/cuidadores/pacientes",
};
