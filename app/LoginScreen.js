...
export default function LoginScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.caregiverText}>Soy cuidador</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  caregiverBtn: { alignSelf: "center", marginTop: 16 },
  caregiverText: { fontSize: 14, color: "#7A57D1", textDecorationLine: "underline" },
});
